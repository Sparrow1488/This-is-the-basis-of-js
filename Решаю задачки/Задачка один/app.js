...
let maxNum = 150 // до какого числа выполнять условие?
...
for (let i = minNum; i <= maxNum; i++) {
    if ((i % 3 == 0) && (i.toString(10).endsWith('4'))) {
        console.log(i + ' делится на 3 без остатка и кончаетсaaaя на 4')
...
// let result = `Программа выявила: ${cal.toString(10).endsWith('1') ||
//  cal.toString(10).endsWith('2') || cal.toString(10).endsWith('3') ||
// cal.toString(10).endsWith('4') ? cal + ' совпадения' : cal + ' совпадений' } с поставленным условием`

switch(cal){
    case cal.toString(10).endsWith("1"):
        console.log("Программа выявила " + cal + " совпадения")
    break;
    case cal.toString(10).endsWith("2"):
            console.log("Программа выявила " + cal + " совпадения")
    break;
    case cal.toString(10).endsWith("3"):
            console.log("Программа выявила " + cal + " совпадения")
    break;
    case cal.toString(10).endsWith("4"):
            console.log("Программа выявила " + cal + " совпадения")
    break;  
    default:
            console.log("Программа выявила " + cal + " совпадений")
    break;        
}
// console.log(result) //вывожу результатaaaaa
